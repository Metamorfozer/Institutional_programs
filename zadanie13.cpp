...
void save()
{
        ...
        if (!(f==NULL))
        {
                ...
                cout << "Напишите 1, если хотите перезаписать,\nпри нажатии другой клавиши просто сохранит содержимое массива в конец файла\n";
                char p;
                cin >> p;
                if (p==1)
                {
